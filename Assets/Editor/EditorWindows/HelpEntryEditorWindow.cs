...
{
    public class HelpEntryEditorWindow : EditorWindow
    {
        ...
        {
            HelpEntryEditorWindow window = GetWindow<HelpEntryEditorWindow>("Help Entry Editor");
    ...
    public class TabCollectionClassInspector : UnityEditor.Editor
    {
        ...
        {
            base.OnInspectorGUI();
            if (GUILayout.Button("Open Editor Window")) HelpEntryEditorWindow.Open(target as TabCollection);
        }
    }
}